...
begin
    ...
    begin
        ...
        assert WriteRegOut = "11111"
            report "WriteRegOut FAILED" severity failure;
        ...
        assert RegWriteOut = '1'
            report "RegWriteOut FAILED" severity failure;
        ...
        assert Result = x"00000000"
            report "Result FAILED with reg = 0" severity failure;

        MemtoReg <= '1';
        wait for 20 ns;
        assert Result = x"FFFFFFFF"
            report "Result FAILED with mem = FFFFFFFF" severity failure;
        ...
        assert Result = x"55555555"
            report "Result FAILED with reg = 55555555" severity failure;

        MemtoReg <= '1';
        wait for 20 ns;
        assert Result = x"AAAAAAAA"
            report "Result FAILED with mem = AAAAAAAA" severity failure;
